...
#######################################
#Temp Fae Event Disable
default faeDisabled = True
...
default first_village_capture = False
...
default catacombsKnowledge = False
default rowanGreyhideLiquorSex = False
default alexiaFuta = False
...
default breakingCliohna = False
default cliohnaRomance = True
...
default bootlegRepeatAvailable = False
default unlockFertilityTreatment = False
default fertilityTreatment1LustAddled = False
default fertilityTreatment1MassiveTits = False
default fertilityTreatment1Milked = False
default treatment1PureEnding = False
default treatment2HornyEnding = False
default treatment3AddledEnding = False
default treatment4MilkedEnding = False
default alexiaPotionStolen = False
default firstTreatment = False
...
default helCuckLiurSeen = False
default ryleaRowanSlave = False
default shayaSex = False
default mindlessFirstTime = True
default tempWhip = 0

#shaya
default privateDanceSeen = False
default shayaSilkAvailable = False
default shayaSilkSeen = False
default shayaClueScore = 0
default shayaMenuCount = 0
default shayaClue1 = False
default shayaClue2 =False
default shayaClue3 = False
default shayaClue4 = False
default shayaClue5 = False
default shayaClue6 = False
default shayaClue7 = False
default shayaClue8 = False
default shayaClue9 = False
default shayaClue10 = False
default shayaClue11 = False
default shayaClue12 = False
default shayaClue13 = False
default shayaClue14 = False
default shayaClue15 = False
default shayaClue16 = False
default shayaClue17 = False
default lirioConfront = False
default liaAttitude = "polite"

default RowanAlexiaXzaratlThreesome = False
default RowanAlexiaXzaratlThreesome2 = False
default RowanXzaratlInfluence = 0
default AlexiaXzaratlInfluence = 0
default RowanXZaratlAnalTraining = 0
default futaCockDenied = False
default xzaratlFinaleSeen = False
default breedingRingAccepted = False
default contraceptionRingAccepted = False
default virilityTreatmentAlexiaDenied = False
default virilityTreatmentSex = False
default virilityTreatmentBreedingSex = False
default virilityTreatmentSafeSex = False
default xzaratlWhippingPromise = False
default alexiaWhippingEnjoyment = False
default whipAlexiaFantasy = False
default alexiaDomCockringSex = False
default xzaratlCockSucking = False
default xzaratlPussyLicking = False
default detoxXzaratlSolo = False
default alexiaWhipRowan = False

# platonic / poly / alexia / rowan
default greyhideRelationship = ''

default moraleEventsActive = True
default moraleEvents = 0
default callingInAndrasSeen = False
default moraleSpies = False
default moraleTrinkets = False
default moraleSlaves = False
default moraleXzaratl = False
default shayaMorale = False
default andrasLootPromise = False

default raeveKeepCapture = "none"

default emissariesPresent = False

default goal3_completed = False
default goal4_completed = False
...
default AlexiaOrcSex = False
default jezCorDancingSeen = False
default pickyCleanupSeen = False
default marySex = False
default drokkEncouraged = False
default consultationAndrasRebuke = False
default consultationAndrasAgree = False
default consultationAndrasUncertain = False
default abandondedPregnancyAspirations = False
default alexiaScolded = False
default promisedFertilityTreatment = False
default alexiaPotionConsoled = False
default mikaelDance = False
default jezInfiltrationSeen = False

default alexiaDegeneracy = 0
...
default guessWhoSeen = False
default patriciaCorrupted = False
default northsideAlly = "none"
default maudDead = False
default maudBroken = False
default rushedCalhoun = False
default calhounCaptured = False
default calhounAlive = False
default guardTrainingAvailable = False
default slumsRaidAvailable = False
default julietKey = False
default alainRomance = False
default werdenConvinced = False
default maudMet = False
default maudFaith = 0
default alainEvent1Seen = False
default alainEvent2Seen = False
default alainEvent3Seen = False
default slumsInterrogatorKilled = False
default banditLeaderJoined = False
default banditLeaderExile = False
default banditLeaderDead = False
default maud2Battle = False
default maudEvent1Seen = False
default maudEvent2Seen = False
default maudEvent3Seen = False
default promisedMaudBetterWorld = False
default promisedMaudPainMisery = False
default maudSex = False
default maudCreampie = False
default maudAllied = False
default loveDelane = False
default alainHelped = False
default mariannesWordsForAlain = "none"
default rowanCharm = False
default rastLocked = False
default slumThugsKilled = False

default sack1Count = 0
default sack2Count = 0
default sack3Count = 0

default original_income = -1
default income_reduced_for = 0

default reduce_tavern_income = -1
default original_research = 0

default movement_points_penalised = False
default original_mp = 0

default reduced_orc_recruitment = -1
default cant_trade_with_villages = False

default iron_reduced_for = -1
...
default old_gold = 0
default delete_mode = False
default rename_mode = False

default nasim_events_disabled = False
default constructed_nasim_chamber = True
