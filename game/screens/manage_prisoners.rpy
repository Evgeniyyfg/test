...
screen manage_prisoners_screen():
    ...
    frame:
        ...
        if castle.buildings['dungeon'].prisoners_auto["test"]:
            text renpy.random.choice(["What does Cliohna do with them anyway? Eh, doesn’t matter.", "It’d be more fun if you sent them to the fighting pits."]) xmaximum 320
        elif castle.buildings['dungeon'].prisoners_auto["gladiator"]:
            text renpy.random.choice(["That’s more like it! Time for some real entertainment.", "Nothing raises morale like a bit of blood sport. My morale, that is.", "Hope this one lasts longer. A good gladiator should last at least a week."]) xmaximum 320
        elif castle.buildings['dungeon'].prisoners_auto["ransom"]:
            text renpy.random.choice(["You’re just letting that one get away? What was the point of catching ‘em in the first place?", "Better than he deserves, but at least I’m getting paid for it.", "Just don’t let ‘em all free. Keep some for me to play with."]) xmaximum 320
        elif castle.buildings['dungeon'].prisoners_auto["slave"]:
            text renpy.random.choice(["Heh, I hope the slavers don’t mind the fresh meat...broken in.", "Breaking slaves is more fun than selling ‘em. But, booze doesn’t pay for itself.", "I might have to give that one a final visit they take her"]) xmaximum 320
        else:
            text renpy.random.choice(["Just pick already. Don’t waste my time with your nonsense.", "I’m bored. You are boring me. Get on with it."]) xmaximum 320
