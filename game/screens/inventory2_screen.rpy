screen inventory2_screen():
    ...
    frame:
        ...
        if avatar.corruption > 60:
            add "gui/status/high_corruption.png"
        elif avatar.corruption > 30:
            add "gui/status/mid_corruption.png"
        else:
            add "gui/status/low_corruption.png"

        if avatar.guilt > 60:
            add "gui/status/high_guilt.png"
        elif avatar.guilt > 30:
            add "gui/status/mid_guilt.png"
        else:
            add "gui/status/low_guilt.png"
