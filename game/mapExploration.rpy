...
init python:
    ...
    def get_event_chance():
        if terrain_data[cur_map.hexes[newHexID][3]][1] == "plains":
            return 11
        elif terrain_data[cur_map.hexes[newHexID][3]][1] == "forest" or terrain_data[cur_map.hexes[newHexID][3]][1] == "hills":
            return 8
        elif terrain_data[cur_map.hexes[newHexID][3]][1] == "swamp":
            return 6
                    ...
                    #Otherwise we check for resources and random events.
                        ...
                        if (cur_map.hexes[world.cur_map.pos_id][5] == False):
                            ...
                            if (cur_map.hexes[world.cur_map.pos_id][6] > 1):
                                ...
                                if (random.randint (0, get_event_chance()) == 0):
