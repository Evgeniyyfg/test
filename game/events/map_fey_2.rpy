init python:
    ...
    event('isdruel_introduction', triggers='map_expl', conditions=('week > 16', 'world.cur_tile_type == "forest"', 'faeDisabled == False',), run_count=1, group='map_expl', priority=pr_map_rnd)    
    event('heartsong_introduction', triggers='map_expl', conditions=('week > 16', 'world.cur_tile_type == "forest"', 'faeDisabled == False',), run_count=1, group='map_expl', priority=pr_map_rnd)  
    event('whitescar_introduction', triggers='map_expl', conditions=('week > 16', 'world.cur_tile_type == "plains"', 'faeDisabled == False',), run_count=1, group='map_expl', priority=pr_map_rnd)  
