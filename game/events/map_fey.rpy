init python:
    ...
    event('maddening_side_of_nature', triggers='map_expl', conditions=('week > 16', 'world.cur_tile_type == "forest"', 'faeDisabled == False',), run_count=1, group='map_expl', priority=pr_map_rnd)
    #The gentle side of nature
    #Can occur on a forest or swamp tile after week 16
    event('the_gentle_side_of_nature', triggers='map_expl', conditions=('week > 16', 'world.cur_tile_type in ("swamp", "forest")', 'faeDisabled == False',), run_count=1, group='map_expl', priority=pr_map_rnd)
