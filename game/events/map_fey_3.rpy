...
"The man behind the counter guffawed and nodded, lifting a hefty mug onto the bartop and filling it to the brim with effortless efficiency. He then slid the mug to Rowan’s hand, who tossed him a few silvers."
...
"His gaze was drawn towards a particular being of draconic nature. Near the center of the room, a tall Dragon Ogress roared with laughter alongside a small table of goblin traders and a lone, ebon-armored human who seemed to be their bodyguard."
...
"The table erupted into laughter as the goblins clapped the unhappy-looking warrior on the back. The Ebon warrior, for his part, did his best to not look the Dragon Ogress in the eyes, calmly sipping from his drink as she pressed her muscular upper body against him."
...
menu:
    ...
    "Take a seat":
        ...
        "A chorus of jeering laughs erupted from the drunk goblins. Rowan saw Ygriss’s brow rise, and her eyelids lower. A sultry smile played across her lips."
        ygris "Prove it."
        ro "How?"
    ...
    "Buy the Dragon Ogress a drink and take a seat":
        $ released_fix_rollback()
...
"Taking this as his cue, Rowan began to move once more. He set a quick tempo, the wet schlicks coming from her sloppy cunt only further enunciating the illicit public dalliance as the cheering goblins egged him on."
...
"The table shifted beneath them with sudden force as all the weight shifted to one side. Rowan nearly toppled over but Ygriss slammed her feet down, reasserting the table’s stability. Another roar of approval arose from the assembled patrons." 
...
"Remembering at least some of his former dignity, a butt-naked Rowan sheepishly descended the table to the ground. Several of the miners proffered a ribald insult or two about ‘finishing what he started’, but Rowan brushed them off." 
