...
init python:
    ...
    event('lost_flock', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    #### Plains Event: The Hanged Man ####
    event('the_hanged_man', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
