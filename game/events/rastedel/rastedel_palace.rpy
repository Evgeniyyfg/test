...
#cg1
scene cg937 with fade
pause 1
show cg938 with dissolve
pause 1
show cg939 with dissolve
pause 1
show cg940 with dissolve
show rowan necklace neutral behind cg940
show ameraine naked happy behind cg940
pause 2
...
menu:
    "Go to her.":
        ...
        pause 3
        show ameraine naked happy behind cg295
        show rowan necklace naked behind cg295
...
"Rowan walked up the austere marble steps of the palace. It was still early. The sun was starting to peek over the tops of the villas and manses that lined the boulevard leading up to the palace. Still, the palace humbled them in both size and opulence."
"The whole neighborhood was an insecure mimic of its design and scale." 
"The purpose of today’s visit was practical. While he was searching for allies and practical benefits to his planning down low, a visit up high would not be out of the question either. How useful would contacts in the palace guard be?"
"Still, he hadn’t expected the entire process to be so easy. He walked up to the guards at the top of the staircase...and they simply let him in. One of them had recognized him from the parade. The benefits of fame."
"Inside though, he was left largely on his own to explore the marble halls. Oh, there were guards at key points. He couldn’t just wander into a sensitive segment of the building. But, now inside, Rowan was left to his own devices."
"He noticed a small painting of one of the Baron’s predecessors in a gold frame to his side. It simply sat unattended. Any number of nobles with Palace access, even those in debt, could have tried to take it. No one could have stopped it."
"Was this place really so sacrosanct? This was a place made with materials beyond stone and jewels. "

show rowan necklace shock at midleft with dissolve

"As Rowan stared at it, someone put a hand on his shoulder. With military reflexes he turned around at the sudden contact, arms moving to a defensive position. But, he jumped for nothing. It was the hand of someone he knew."

show doran beardless neutral at midright with dissolve

dor "Ah, Rowan, my boy. No need to raise arms."

show rowan necklace neutral at midleft with dissolve

ro "My lord. Apologies."

"Rowan lowered his hands. Duke Doran had recovered some of his luster in the intervening months. But, the beard had not come back. Jezera had commanded him not to regrow it, and Doran was an obedient servant."

dor "We needn’t speak like that in private anymore, my boy. We both are tools in the same hands."

ro "..."
ro "To what do I owe the surprise?"

dor "You’re the one whose appearance was a surprise. I had scheduled tea with the Baron weeks in advance. Not an easy task, but of course they made time available for a man of my standing."

ro "Yes, of course."

dor "In fact...would you like to join us? The hero of the realm, regardless of how he is dressed, is a fit guest."

"Rowan put a hand to his chin. He hadn’t intended to visit the Baron today. But, to do so could serve a purpose. Especially if…"

ro "Will the High Arbitron be in attendance?"

dor "Not today, I’m afraid. Naturally, I can call on her as well if so desired. But, she is a woman of many important duties. She cannot be with the Baron day and night both. I was content with merely the Baron in this instance."

"A chance to actually speak to the Baron without Marianne whispering in his ear. A chance, perhaps, to ask for some kind of favor that might aid him in setting up a less bloody fall for the city. It was a chance that was not to be missed."

ro "In that case, I accept. Thank you for the invitation, my lord."

"Rowan marveled at the endless maze of rooms and decorations. He hadn’t had a chance to slow down and really take in the sheer grandeur of the place. The massive banquet tables, the elaborate chandeliers. Jewels that must have taken lifetimes to extract from the ground."

#doran concerned

dor "Since circumstance has brought us together…"
dor "Perhaps you’d be willing to indulge me in a bit of information? I have been doing my part for Mistress Jezera in Werden’s inner circle, of course. I am the lady’s eyes and ears."

if rastAlly == "jacques":
    dor "And yet, I often find myself not fully kept up to date with what is going on by Lady Ameraine. I was taken by surprise to learn that you had been working with Lord Mineur."
    
else:
    dor "If not with planning...whatever it is you and that woman in black are planning, then surely in Duke Werden’s council chambers. Another trusted voice at his ear would surely be of service."

dor "Naturally I serve in whatever role I see fit."
dor "But, surely someone of my rank could act in service of our masters better if…"

show rowan necklace angry at midleft with dissolve

"Rowan drowned out the rest of it. The topic of Raeve had come up with Ameraine, of course. He had his uses but stripped of money and territory his reach was limited at best. His role as a piece on the game board maxed out when he was returned."
"Perhaps, were he not so stupid, they could still find an important role for him in the plan. Perhaps important enough to involve him in deliberations. But, if he were smarter he wouldn’t be so easy to control in the first place."

show rowan necklace neutral at midleft with dissolve

ro "When I next return to castle Bloodmeen, I will bring up the matter with Jezera. If she deems it fit, we’ll make extra sure to fill you in on the details of our deliberations."

#doran happy

dor "Excellent excellent. Her wisdom is the best means to decide."

"Rowan looked up. The centerpiece of the room, the massive stained glass window of a rosarian rose, stood tall and proud behind the throne. It bathed the throne and its steps in red and gold light." 
"A table had been set up in the middle of the room. The same type as had been there during the banquet back before the battle."
"Sitting at the table, was Baron Casimir IX De’Rosa. The ruler of Rosaria. Nominally."

show casimir neutral at edgeright with dissolve

casi "My friend, Doran…"

#casamir excited

casi "And Rowan Blackwell? My word."

"Rowan bowed low."

ro "Your Highness, it is inspiring to see you in good health. I hope I am not intruding."

"The Baron weakly swatted at the air with a bony hand."

casi "You are always welcome here, Rowan. Always welcome."

"Rowan kept a smile on his face as he waited for a servant to bring a third chair. Yet, he could not stop from stealing glances at the Baron."
"The Baron made for a surprisingly austere sight for a man so covered in gold and finaries. He was skinny and grey skinned. Like there was not enough of him to fill his regal robes."
"Rosaria had been ruled by the De’Rosa family for its entire existence. Their true title was that of Kings. But, they still ruled by the style “Baron”. An honor to their ancestors from the empire of old."

if avatar.corruption < 61:
    "The Baron had not always been like this. He had not been in active command on the field during the way, but his role in the organization and defense of the region was well known. Never a bright flame, but certainly not this."
    "Where had that man gone?"

else:
    "Even looking at him made Rowan want to clench his fist. The enemy could be at the gates at any moment. This was war. And the ruler of Rastedel was this man?"
    "No wonder Rowan’s plans kept working so easily. Rosaria was fettered to a corpse."
    
"Soon the servant returned with the table and tea was served in exquisite porcelain cups. The fragility of it surprised Rowan. He almost broke his teacup the first time he took a sip."

casi "It’s good, yes? They tell me the tea comes from the east. The Dragon’s Tail perhaps?"
casi "Solansia alone remembers."
casi "I can instruct me pageboy to give you some. All you need is warm water. Very easy to prepare."

show rowan necklace happy at midleft with dissolve

ro "That is quite alright, Your Highness."

#doran neutral

"Doran, being Doran, took the opportunity to jump in."

dor "Your taste is exquisite, Your Highness. You do me honour."

#casimir neutral

casi "No need to thank me. Her Beatitudes suggested this flavor to me years ago. I’ve drank it ever since."

"Rowan looked down at the brown water in front of him. There was a face in it, obscured by the surface."

show rowan necklace neutral at midleft with dissolve

ro "You rely on her, a lot don’t you? Since my return, this is my first time even seeing you without her."

#casimir happy

casi "High Arbitron Marianne? Of course. Of course. "

"Casimir smiled. It was weak and exposed that some of his teeth had been replaced with gold. But, he smiled with his whole face. Eyes and Cheeks and Lips."

casi "Wonderful woman. Kind and considerate. And really cares about the people. "
casi "We pray in the evening, every day. She pays me a visit in the palace. She can banish the demons in a man’s very soul."
casi "Such a thing. Magic."

"Doran made a show of nodding sagely. The Baron looked off towards the throne behind him. "

show rowan necklace happy at midleft with dissolve

ro "I can see why. Running an entire kingdom must be quite challenging. She must be quite useful to you."

casi "It’s not just useful. No. Not use. She’s special. She really is."

"He turned back to Rowan."

casi "But, yes. Also hard working too. Very hard working."

#casimir sad

casi "Running a kingdom. Power. Such a thing..."

"What Rowan, really wanted to ask about was those “prayer sessions” that Casimir had mentioned. Were those the same sessions that were the subject of all of the rumors?"

#casimir happy

casi "You have kids, yes?"

dor "A daughter, but she’s off doing her duty. "

if helayna_escaped == False:
    "Rowan would argue so, at least."
    
else:
    "As far as Raeve was aware, she was still in service of Bloodmeen."
    
casi "And you, Rowan?"

"Rowan coughed."

ro "No children, your highness. Just a wife back home."

casi "Back home. Hmm. Is that where the danger is? Is she safe?"

ro "I try my best to keep her that way."

casi "That is good. That is good. Keep her very safe. Family is important. So important."

#casimir sad

"The Baron’s eyes visibly sank. He leaned back into his chair, a smaller man in a mere moment then he had been when talking about his and Doran’s family. The story of Baron Casimir’s family was an infamous one."

casi "Thinking of family...hmm."
casi "The High Arbitron told me not to speak of this much. I should listen to her. Still..."
casi "But, once I had thought of abdication. Give power to Cas. Such a bright boy. So bright. During the war, we gave him tests, you see. Govern this. Manage that. Good at it too."

dor "All of the nobility mourns his passing."

"The Baron eyed Doran wearily. The duke was was all stiffness and formality. Perhaps that was the rules of court for something of the sort. Rowan knew it was the wrong response, though."

casi "Yes...yes…"

if avatar.corruption < 31:
    show rowan necklace concerned at midleft with dissolve
    "Rowan’s heart sank to watch this. A father musing about his lost son. There had to be something Rowan could do to help."
    ro "Your Highness. There is something you should know. I’ve heard the rumors about your son’s last hours the same as any man in the army. But, I heard other stories too."
    ro "A friend of mine who was at the battle said they saw him and his standard rallying to cover the retreating flank. I know for a fact that he didn’t rout."
    show rowan necklace happy at midleft with dissolve
    ro "You shouldn’t listen to anyone who says otherwise. He was a good man. A hero even."
    "In truth, Rowan had never spent time with any veterans of that battle. But, from his mouth it would be believed."
    #casimir shocked
    casi "Covered the retreat?"
    #casimir happy
    casi "..."
    casi "I’ve never heard that before."
    #casimir sad
    casi "..."
    
casi "It matters not. My abdication can no longer happen."
casi "Cas’ children are not of age. Marianne tells, as well, me they spend so much time at the Camelia Lodge. She has such horrible stories. They’re not ready."

"Doran gave a self important nod."

dor "Indeed, I saw young Matilda just the other day at…"

"The conversation followed events in high society for a time. Rowan largely listened but didn’t speak. Casimir nodded along and would show interest at times when the subject was an old friend. But, otherwise it was Doran who extended over the conversation."
"Rowan was startled when Baron Casimir turned back to him."

casi "You are still dear Doran’s vassal, yes?"
    
show rowan necklace concerned at midleft with dissolve

ro "That is correct. My town is...was...in his territory."

casi "Oh."
casi "I can’t remember. I can’t remember. Did you ever receive that keep?"

show rowan necklace shock at midleft with dissolve

ro "Keep, my lord?"

"Rowan’s jaw loosened. By that, did he mean…"

casi "Yes. Keep. I think I suggested it some time back. Right after the war. A promotion to viscount. Or landed knight. I don’t recall. But, there was to be a keep along with it."

show rowan necklace concerned at midleft with dissolve

"Rowan fell silent. How could even respond to that? It wasn’t that Rowan was unaware of lost promotions and recognitions. But, this? A keep. He couldn’t imagine it in his wildest dreams. He could have been a lord."

casi "I suppose that didn’t happen, did it? The keep would have been east. Quite Odd."

"Casimir scratched his head and asked off to the side. Rowan wasn’t even in the conversation anymore."

casi "Why didn’t that happen?"

dor "I recall that plan, your excellency. I believe it was Duke Werden who’d objected. "

casi "Ah. Our friend Antoine. I think I can recall that. Damn near twisted my arm off, didn’t he? Heh. It was a different time."

#casimir happy

casi "A shame. You deserved it, Rowan. Truly."

"The expensive cup slipped from Rowan’s hand and spilled black tea all over the expensive tablecloth. Rowan blinked. His hand was shaking."

casi "All is well, friend?"

ro "Y...yes. My mind was on the battlefield."

casi "Good good. Much depends on that mind."

"Rowan lowered his head to his hands. He checked the teacup and luckily found it without a crack." 
"Such a funny thing. Worrying he might break a teacup."

dor "Rowan is still quite hard working, after all. So perhaps you will have another chance to reward him later, my lord. Especially after his heroics at the abbey and my own keep."

casi "Indeed."
casi "You know...Is there some way I could assist you, Rowan?"

show rowan necklace neutral at midleft with dissolve

"Rowan paused. He had to focus on the task. Focus on the task. The Baron wasn’t exactly the one making the decisions anymore. But, technically, any letter signed with his name was law." 
"The only problem would be convincing him to do it. The absence of many orders signed by his hand, but without Marianne’s approval meant he wouldn’t just listen to any random noble’s idea."

#todo - if diplomacy is above X:
show rowan necklace happy at midleft with dissolve
"Rowan laid out a plan to move a portion of the guards from the outer wall to a reserve position in the city itself. He used his finest rhetorical skills to make it seem like a strategic reserve would be a brilliant maneuver."
"In truth, it would mostly be useless for stopping infiltration tactics. But, he had Baron Casimir nodding along in rapt attention. Even Doran scratched his naked chin and huffed in approval."

#else:
#rowan neutral
#casimir neutral
#"Rowan haltingly came up with a plan to move a portion of the guards from the outer wall to a reserve position in the city itself. He tried to explain it as well as he could, but he caught the Baron looking off into the middle distance at a few points."

"When Rowan finished, Baron Casimir took a long sip of tea. Rowan and Doran waited, perfectly still, for him to speak."

#todo add diplo pass to below as "or"
if avatar.corruption < 31:
    casi "Perhaps I should bring up the idea to the High Arbitron…"
    "His words came out haltingly. Even as he said it, Rowan spotted an opportunity."
    ro "It’s a technical military security matter. She’d need to ask her own military aids. Her wisdom is vast, but if there’s one thing I know, it’s how to win a siege."
    casi "I suppose…"
    casi "Here."
    # if diplo failed - casimir happy
    "The Baron stood, walked over to a nearby cabinet, and drew a scroll of parchment and quill from it. Rowan and Duke Raeve watched in silence at Casimir chicken scratched orders on it."
    # if diplo failed - rowan happy
    "Rowan couldn’t stop himself from smiling. He had come here on a lark, but this had worked out marvelously."
    casi "Will this work, Rowan?"
    "Rowan looked over the parchment. It’s writing was in a near illegible hand. But, the signature of the Baron was impossible to miss and easy to verify. If he gave this to a commander, the order would not be questioned."
    ro "Perfectly. Thank you, Your Highness. You’ve done much to help defend the city today."
    "The Baron looked pleased with himself as well."
    casi "It’s funny. This might be the first thing I’ve done in weeks to help the city."
    casi "What a marvelous lord I am. Marvelous. "
    casi "Heh."
    "Baron Casimir looked away from Rowan as he shakily placed the parchment into Rowan’s hands."

else:
    casi "I see. I see."
    casi "..."
    #casimir sad
    casi "I shouldn’t make any decisions like that without asking the High Arbitron, though. She wouldn’t like that."
    "He gave his beard a gangly scratch."
    casi "Yes. That would be best."
    casi "I’ll just tell her about it tonight or...actually write it down. Yes. That would be good. Yes. Write it down and I will give it to her."
    #casimir happy
    "Casimir smiled as though he’d done something helpful. Rowan struggled to smile back."
    show rowan necklace happy at midleft with dissolve
    ro "An excellent idea, Your Highness. She would want a look at the idea as well."
    show rowan necklace angry at midleft with dissolve
    "When the Baron next turned around, Rowan let out a long sigh. It had been a good plan. Perhaps it might have worked. But, he was just too deep in Marianne’s pocket."
    
show rowan necklace neutral at midleft with dissolve

"The conversation continued for another twenty minutes, but it was mostly pleasantries after that. Baron Casimir was kind and gracious, if not entirely present, so it would have been difficult for Rowan to be impolite if he tried."
"But, from the moment the discussion of the order was done, Rowan was acutely aware of the ticking clock. Every minute spent here was another minute spent closer to the coup."
"At the end of the scheduled tea time, Baron Casimir walked them to the doorway of the chamber. Pageboys rushed in to clean off the table...including to deal with Rowan’s tea spill."

#casimir sad

casi "Many people live in this city. Many good people. You must protect them, Rowan. You must."
casi "You have a purpose. Everyone must serve a purpose."

"The Baron smiled sadly to himself. Rowan didn’t ask him to elaborate."

#todo - if diplo passed
scene black with fade
"Rowan practically rushed out of the palace in order to make it the north side of town. Better to get the order in before Marianne learned, after all."
"At the gate, he found some confusion, but soon the commander had selected a portion of his forces to move back in reserve. No one was going to deny an order hand signed by the Baron and delivered by Rowan himself."
$ rastCrime += 1
$ released_fix_rollback()
...
#else
#scene black with fade
#"Rowan shuffled off. He could still try to extract some influence from a conversation with the guards, but the prospect didn’t seem quite so strong anymore. The day would likely go down as a waste."
#$ released_fix_rollback()
#$ prevent_tile_exploration()
#$ push_to_previous_tile()
#return
...
"Rowan went back to the palace briefly, hoping to get another word in with The Baron. Perhaps, he might have a chance to speak to members of the palace guard. But, he found that the Baron wasn’t in."
"In fact, when Rowan went to the base hall of the royal guard, he found the effort pointless. The commander he spoke to gave him winks and nods. They were in the know too."
"If you Rowan wanted good chess pieces for the coming chaos, it would not be here."
"Without results, Rowan left early. There would still be time to do something with the day."
