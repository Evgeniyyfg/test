...
scene cg793 with fade
pause 1
show cg794 with dissolve
pause 1
show cg795 with dissolve
pause 1
show cg796 with dissolve
pause 1
show cg797 with dissolve
pause 2
...
if avatar.corruption < 31 and serveChoice != 4:
    ...
    "Bringing down Rastedel. Once the very idea might have been unthinkable. But, much had changed. The more he thought about it, the more possible it seemed. Perhaps such a thing might even bring about positive changes."
    "So long as Andras could be kept from his natural impulses, that is."
...
menu:
    "Accept the mission.":
        ...
        if avatar.corruption < 61:
            show rowan necklace neutral at midleft with dissolve
            "Rowan sighed darkly. The more he considered it, the less good he felt an act of defiance would do. She’d still subvert Rastedel, only without him to keep her in check."
            ro "You’re a monster, you know that. One day I will kill you."
            je "Obviously. Should I take that as a sign of your acceptance?"
            "Rowan scowled but nodded. There was nothing more to be done. He didn’t really have a choice."
            
        else:
            show rowan necklace neutral at midleft with dissolve
            "Rowan sighed. There was just no winning with Jezera. The entire situation smelled of a disaster, but if his life depended on acting on the twins’ behalf then there was nothing else to be done."
            ro "I suppose you’re right. I don’t have much of a choice, do I?"
            je "Now you see reason. Shall we get on with it?"
            "Rowan nodded somberly."

    "Refuse the mission.":
        $ released_fix_rollback()
        if avatar.corruption < 31:
            "Rowan shook his head slowly. What the order entailed was deadly clear. But, it stood at odds with every impulse in his body."
            show rowan necklace neutral at midleft with dissolve
            ro "There are a hundred thousand people in Rastedel. I’ve helped you thus far, but you cannot truly mean for me to commit such a crime."
            ro "What kind of man would I be if I did this?"
            show jezera displeased at midright with dissolve
            "Jezera’s eyebrows narrowed. Her gaze contained all manner of malice."
            je "I truly mean exactly that. You will aid my brother and I in the taking of the city."
            je "You are our slave, Rowan."
        
        elif avatar.corruption > 60:
            show rowan necklace angry at midleft with dissolve
            "Rowan laughed to himself."
            ro "I harbor no love for the Rosarian Nobles. But, we cannot pretend I did not witness what I did. To conquer a city is a serious thing."
            "Rowan poked at his fingernails."
            ro "What if I said no?"
            show jezera neutral at midright with dissolve
            je "After all this time. Everything you have done until now. You still have sentiment for these cockroaches? You would still refuse?"
            ro "Perhaps…"
            show jezera displeased at midright with dissolve
            "Jezera’s eyebrows narrowed. Her gaze contained all manner of malice."
            je "Then perhaps I should remind you that for all the freedom to explore my brother and I grant you, you are still a slave."
                        
        else:
            show rowan necklace angry at midleft with dissolve
            "Rowan balled his hand into a fist."
            ro "You seriously expect me to do such a thing after what I just witnessed? The Rosarian nobles are monsters, but there are still thousands who live in that city. "
            ro "There are still lines I wouldn’t cross. Even after my part in...all that has already transpired…"
            show jezera displeased  at midright with dissolve
            "Jezera’s eyebrows narrowed. Her gaze contained all manner of malice."
            je "I seriously expect this of you, yes. Your role is the option Andras and I have agreed upon. If not you, then I can give the city assignment to someone more willing."
            je "Because, let’s not mince words, Rowan..."
            
        je "You do not have a choice. If you will not bring Rastedel to me, I will simply dispose of you and your little wife and then find an agent who will do what you cannot."
        je "Perhaps one with the proper amount of compassion for the humans inside."
        je "Do you understand the consequences of continued disobedience?"
        "Jezera took a step back and stretched out her fingers. It brought Rowan back to where he was. He was alone, in the dark, with the demoness."
        menu:
            "Ready for a fight.":
                $ released_fix_rollback()
                "Rowan put a hand to the hilt of his sword. Already the first pumps of adrenaline were shooting through his veins. He’d just defied her on an issue of grave importance."
                je "I’ve already given you more chances then I’d give anyone else. Should I take your silence to be a final refusal?"
                "Rowan nodded slowly."
                ro "Surely there is some other way that I can serve you? You know this is asking too much of me."
                ro "You’re more clever than this. Surely we can work out a deal."
                "Jezera stroked one of her long fingernails down her cheek."
                je "It is not as though you wouldn’t still be useful in some capacity…"
                "Rowan felt some of the tension leave his shoulders. He was walking on brittle sticks, but perhaps he could talk his way out of this."
                je "...But, if you won’t serve, you’d be much more useful as an example of the effects of defiance."
                "Rowan lunged, he had one chance. Jezera seemed genuinely surprised by the speed of the strike, and only narrowly dodged out of the way."
                "But, that one strike would be his only chance at surprised. As he adjusted to swing again, Jezera aimed her hands at him."
                "Rowan ducked narrowly out of the way of the lightning tendrils shooting from her hands."
                "Only, once he’d dodged that attack, another followed. He could only blink as two giant serpents were conjured from the air. He had mere seconds to react before they were lunging at him with hissing tongues."
                "Rowan rolled and struck back with his ferocity. One serpent went down. Then the next. But, as he turned back from the slain foes, Jezera’s hands were pointed at him again. She was at a safe distance now. There would be no escape."
                je "Stupid."
                show rowan necklace concerned at midleft with dissolve
                "Rowan groaned as tendrils of pure energy struck him square in the chest. He had presumed that would be his end. Splattered like the dark elf whom she’d so ruthlessly dispatched."
                "Instead, he felt the tendrils wrapped tight around him. His sword fell from his hands and he soon could no longer feel the ground against his feet."
                je "Stupid. Stupid. Stupid. Stupid. Stupid."
                je "Oh, we’ll find a new role for you. But first, we’re going to have to clear out that stupid little head of yours."
                "His body began to move, totally the captive of the tendrils. It was hovering closer and closer to the iron gate."
                ro "...No."
                "Jezera just smiled. The iron door opened with the same stillness as before. Once more came the putrid stench and the sight of fleshy appendages pounding into pliant human flesh."
                scene black with fade
                "Jezera flung Rowan into the room. He could do little but reach out in horror as the door closed behind him." 
                "He was locked in with the creature. Soon the tentacles were moving towards him as well…"
                
                menu:
                    "Show bad end.":
                        $ released_fix_rollback()
                        #bad end CG
                        scene cg588 with fade
                        pause 3
                        "Hell. That’s what the man who once called himself Rowan would have called this place."
                        "Hell. A never ending torrent of ecstasies, agonies and aphrodisiac-inspired dependency on this writhing, roiling creature known as the wulump."
                        "...Not that Rowan knew what a ‘wulump’ was, anymore. He struggled to recall his own {i}name{/i}, half the time. Such needless terms and waggled words were a waste of useful breath."
                        "Rowan kissed the fat tentacle filling his mouth with the ardour of one incapable of communicating just how much he was in love with it. He adored the feeling of it sliding wetly across his lips like nothing else in this world."
                        "The Master - {i}his{/i} Master - was a being of boundless generosity, gifting him with its sickly-sweet juices and filling every, clenching orifice with its ever-expanding love."
                        "Rowan had never known what pleasure was before he was unceremoniously cast into this place. He {i}thought{/i} he had known: the ambitions of life, of love, and power and duty and conquest had all seemed so important to him once."
                        "No longer. They were flimsy shadows hiding the dawn. Pathetic fog brushed away by the merest hint of a breeze."
                        "His Master was that breeze."
                        "His hands reached out in grimy pit he found himself in, finding purchase on the thickening tendrils of his Master’s tentacles."
                        "There were more - {i}far{/i}, far more - than he could ever possibly pleasure at once. That was what he loved about it the most: the wulump was never satisfied, always ready to give him more."
                        "As if to underscore that fact, a newer, fatter tentacle blushed against his gaping ass, slipping into his inner recesses with little more than a moan and a slimy {i}pop{/i}, joining its fellows in its eternal and systematic mission of demolishing his ass."
                        "Rowan cooed at the full sensation inside his guts, giggling madly between the length that filled lips as he tasted the sweet nectar of his love in every part of him."
                        "Even his ears, his nose, his {i}eyelids{/i} were openings to ravish. Little tendrils tickled at the insides of his brain, moving, twisting, turning to an interminable best that the wulump set, and Rowan eagerly followed."
                        "What should have been pain was pleasure, what ought to have been horrifying was orgasmic. Rowan let out a muffled pig’s squeal as his eternally-erect prick pulsed and thickened and spurted."
                        "The wulump was generous. No sooner had he came than he felt his testicles churning once more with lust." 
                        "Perhaps it was the creature’s magic that made him this way. Or maybe it was it’s delicious juices that kept him filled to the brim. Rowan didn’t know, all he knew was that he wanted more. Always more. {i}Forever{/i} more."
                        "His skin was slick with sweat and cum and wulump fluids. He bucked his hips and thrashed against the thick, grey mass that had once been a tiny creature."
                        "Beneath the mass of serpentine coils to his left, there arose a shuddering groan. His wife was in there somewhere, as lost in the throes of rapturous torment as he was." 
                        "To his momentary shame (when he could find time to feel it), Rowan would do everything he could to remember her name. But a fog lingered over his mind. All he could remember was the color of her hair."
                        "Red… her name was Red, wasn’t it?"
                        "They were finally, truly reunited: Rowan and Red. No longer man and wife, but rather fellow travelers on their Master’s endless cycle of fornication and euphoria."
                        "Red had struggled at first, just as he had. Rowan remembered finding that strangely touching. But such meager efforts faded in the passionate embrace of their mutual lover." 
                        "Whatever struggles or differences they’d had in the past (if, indeed, any had existed) were wiped away. They were one, together for eternity."
                        scene cg589 with fade
                        pause 3
                        "As if reading Rowan’s desires, the wulump produced her."
                        "Red’s rigid, trembling form arose up from the coiling muck like a slick Phoenix being birthed. Her eyes rolled in her head as the tentacle that had lodged as deep as her duodenum retreated like a slithering snake out of her throat."
                        "Red let out an orgasmic gasp, her body propped up by tentacles as they lifted her bodily over to the section of the creature where Rowan was located."
                        "Rowan felt similar tentacles wrap around his wrists, his arms, his legs, drawing him upwards in a lewd marionette. All the while, the tentacles lodged in Red’s twat and Rowan’s ass kept pistoning in and out, in and out."
                        "Upon catching sight of Rowan, Red let out a wordless gurgle of joy. She could no more recall his name than he could hers, but they recognized each other all the same."
                        "He smiled like a newlywed at his first bedding as she was lowered down beneath him, spun about on all fours so as to more easily engender their imminent mating."
                        "The Master - kind as always - removed itself from their orifices just long enough to help align Rowan’s twitching cock into her feminine folds. The clench of the tentacles around their limbs helped to simulate a coitus neither was strong enough to induce on their own any longer."
                        "Rowan bit his lip as he watched himself slide home inside of Red. They let out matching cries of delight, cut off simultaneously by the choking wetness of the wulump stuffing itself down their throats."
                        "It thrashed them together in a rough approximation of their old lovemaking. But rougher, harder, like smacking two dolls together. Rowan loved every second of it."
                        "He moaned between the length sliding down his throat, which the wulump took as the desperate request that it was. Within seconds, both Rowan’s and Red’s asses were filled once more with juicy, slick lengths."
                        "They both cried out, united in a way they couldn’t have possibly imagined when they first began his long journey together."
                        "The old Rowan might have fought, he might have screamed or cried or raged at his confinement."
                        "Come to think of it, Red (that was her name, right?) might have, too. But they were no longer those people anymore, they had grown so far beyond that."
                        "Rowan felt his testicles clench as he unloaded a truly massive load into Red’s pussy. She screamed out encouragement, flailing her hips back against him in an attempt to get him deeper."
                        "Hell… that’s what he would have called this, once. His Master had shown him otherwise."
                        "Rowan wasn't a hero anymore. He wasn't even a {i}man{/i}, really. He was just a lump of flesh, a thing to be used until he could not be used anymore."
...
if avatar.corruption < 60:
    "Rowan followed along beside her, but didn’t have much to say on the matter. He had a city to bring to its knees. Dark deeds to perform. There was much more thinking to do then there was partying."
