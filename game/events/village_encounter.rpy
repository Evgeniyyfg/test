...
init python:
    ...
    event('trade_ev1', triggers='village_trade',  conditions=('not new_goblin_prince_rumor', 'not cant_trade_with_villages'), run_count=1, group='village_trade', priority=pr_map_res)
    ...
    event('trade_ev3', triggers='village_trade',  conditions=['not cant_trade_with_villages'],  run_count=1, group='village_trade', priority=pr_map_res)
