...
init python:
    ...
    event('local_guide', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    # A minor noble's gift (choice)
    event('minor_noble_s_gift', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    #Bandit attack (malediction)
    event('bandit_attack', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    #Snake bite
    event('snake_bite', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    # Monster hunter team
    event('monster_hunter_team', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    # Blighted farm
    ...
    event('site_of_occult_ritual', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    #Drakken highwaywoman (malediction)
    #No requirements
    event('drakken_highwaywoman', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
