...
init python:
    ...
    # Famine Looms
    event('famine_looms', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    ...
    # Goblin Scouts
    event('goblin_scouts', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    # Is Rowan A Thief?
    event('is_rowan_a_thief', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    # Travelling Monk
    event('travelling_monk', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    # Please Fetch Medicine
    event('please_fetch_medicine', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    # Orcs in the North
    event('orcs_in_the_north', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    # Ancient Chest
    event('ancient_chest', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
    # Thief in the Night
    event('thief_in_the_night', triggers='map_expl', conditions=('world.cur_tile_type == "plains" or world.cur_tile_type == "road"',), run_count=1, group='map_expl', priority=pr_map_rnd)
