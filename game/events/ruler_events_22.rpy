init python:
    ...
    event('shayas_gift', triggers="week_end", conditions=('castle.buildings["brothel"].lvl >= 1', 'week >=4'), group='ruler_event', run_count=1, priority=pr_ruler, weekend_auto=False, weekend_room="bg24")
...
"Rowan stared back at the portal with a weary expression. He’d just returned from the field after another week of operations. He could depart, of course, but his mind was still taking stock of his progress and failures of the past week’s operations."
"He was distracted enough that he didn’t notice for some time that he wasn’t alone. Though, this particular visitor seemed to have a talent for not drawing attention to herself."

show shaya neutral at midright with moveinright

ro "Shaya?"

"The brothel's madam was waiting in the doorway, watching him silently. When he turned to her to address her, she adopted a lower posture. Head downcast, st, and hands clasped together behind her back, her ample chest rose slightly."

sha "It is good to see you again, Sir Rowan. I’m sorry if I am intruding."

show rowan necklace happy at midleft with dissolve

ro "No no. It’s alright. Your timing was perfect. Is there something you wanted to speak to me about?"
...
if avatar.corruption > 30:
    "Not that he put that much effort into resisting that impulse."
...
ro "This is quite useful. Thank you Shaya."
...
sha "Really? You give me an honor I don’t deserve. This was the most meager of services I could provide. Especially towards a man of your stature."

if avatar.corruption < 61:
    "Rowan scratched his head."
    ro "I’m not all that special. You don’t need to talk like that."
    
else:
    #ro smirk
    "A grin went to Rowan’s face. This was clearly just flattery. But, what was wrong with a bit of indulgence?"
    
ro "Surely though, this is a common occurrence at the brothel. Jezera selected it as the base for her spies after all. They must be overflowing with stories."

"Shaya giggled into her hand."

sha "Overflowing with stories...and other things. Yes. But, we needn’t talk about it now. I’m sure your adventures make mine look like triflings by comparison. No one needs to hear about the petty squabbles of whores."
sha "Sir Rowan. I’d much rather hear about you."

"She clutched his hand in both of hers and held it close to her."

if avatar.corruption < 31:
    "Rowan pulled it back, a red blush involuntarily forming on his face."

"So, Rowan began to talk about his job in the field. Shaya worked with him, so there was no harm in going into detail."
"Initially, he kept his explanations quite general, but Shaya proved a surprisingly excellent listener."

sha "Surely, the human villagers must be loyal to their overlords, though? I must admit that the places beyond the walls of Qerazel were no place for a girl like me. But, among travelers, they speak of how every peasant knows who their immediate superior is in the empire."

ro "Perhaps that is true. In the empire. But, in Rosaria…"

"After a while, Rowan found his shoulders easing somewhat. It had been too long since he had a conversation like this with someone in the castle. It seemed like Shaya wanted to know everything."
"In fact, it went on so long that Rowan almost forgot he had a job to do."

sha "Wait! Sir Rowan! Please, before you go, will you listen to my plea?"

show rowan necklace neutral at midleft with dissolve

ro "Hrmmm?"

sha "Once a week, during days when you’re in the castle, I take a break from official work and join the other girls on the floor. There is a...dance...and it is quite popular."

ro "I’ve heard mercenaries speak about it. You’re bleeding a few of them free of their wages."

sha "Is that so? There’s a sense to that. What’s money for if not to buy a little slice of happiness?"
sha "But, if you decided to come down and attend one of my performances, rest assured you would not have to pay. It is just a show, and not a night with a girl, after all. Besides, in some respects, we’re business partners. Are we not?"

if avatar.corruption < 61:
    show rowan necklace happy at midleft with dissolve
    if avatar.corruption < 31:
        "Rowan blushed slightly and glanced to the side to avoid looking Shaya in her piercing ochre eyes."
    ro "We’ll have to see about that. I make no promises."
    sha "That you are considering it...that thought is enough. When next I perform, I will seek you in the audience."
    if avatar.corruption < 31:
        ro "..."
    else:
        ro "You’re such a tease, woman."
        sha "I should hope so. It’s my profession."
        
else:
    #ro smirk
    ro "If you’re offering me a show for free, I’ll have to take you up on that."
    "With Shaya this close to him, near pressed to his chest, he couldn’t resist the urge to…"
    "Pinch."
    show bg6 with sshake
    "Shaya grunted softly and went up on the tips of her toes at the sudden feeling of Rowan’s fingers pinching her ass through the thin fabric."
    sha "Hrmph. That one, I might just have to charge you for."
    ro "Too far, huh?"
    sha "Of course not. I’d be a sad courtesan if I didn’t enjoy a bit of attention, would I not…?"
    "She gave him a small wink."
    sha "...But, so would I too if I gave away more than a sample for free."
    
    
show rowan necklace neutral at midleft with dissolve

"Afterwards, Rowan returned to his room to change out of his dirty clothes. But, his mind lingered on the conversation he had just left." 
"The information that Shaya had provided would be of use. And she seemed to constantly prove herself such a warming presence. Yet, when he was around her he often found himself feeling..."

menu:
    "Be mistrustful.":
        $ released_fix_rollback()
        "...Like he needed to be careful. This woman was a master at extracting information from hapless men. Did Rowan believe himself to be above such things?"
        scene bg9 with fade
        show rowan necklace neutral at midleft with dissolve
        "As he entered his room, his eyebrows furrowed and his glance went to his desk." 
        "The note from his first meeting with the brothel keeper was, no doubt, still wedged snuggly in the treatise he’d placed it."
        "{i}Who is Shaya?{/i}"
        if avatar.corruption < 31:
            "...Perhaps he could justify a trip to the brothel after all..."
        else:
            "...Perhaps a visit to the brothel might offer more than just entertainment..."

    "Be horny.":
        $ released_fix_rollback()
        show rowan necklace aroused at midleft with dissolve
        "...His heart racing. When she was around him, she was so civil and professional. But, her profession never left his mind. And the provocative way she dressed made it so hard to think of anything else around her."
        scene bg9 with fade
        show rowan necklace neutral at midleft with dissolve
        "He sighed when he entered his room and glanced at his desk." 
        "The note from his first meeting with the brothel keeper was, no doubt, still wedged snuggly in the treatise he’d placed it."
        "Surely, a visit to the brothel for information would be a worthwhile endeavor. Right?"
