...
menu:
    "Threaten to stop.":
        ...
        "Taking his hands from her body, he placed them on the counter at either side, and arced backwards so they were no longer touching."
...
menu:
    "Ask her to blow you.":
        ...
        "Feeling him begin to shudder, Alexia stopped sucking on his dick and grabbed it by the base."
        ro "I’m so close...."
        "Keeping a tight grip, she backed off until his cock was no longer inside her mouth, and grinned up at him."
...
"Alexia leaned in close and gave him a long, deep kiss before sitting up and sliding her legs off the bed."
...
"Rowan opened the door to discover, standing before him, a beautiful young woman. Drawn around her was a red cloak, the hood pulled up to conceal her pale silver hair."
"Her attractive face wore a look of extreme worry, something was clearly very wrong."

$ jezera_name = '???'

je "Thank Solansia you are home, Hero, I need your help. It is my daughter, she’s... she’s..."

"Before she can get the rest of her sentence out, the woman burst into tears."
...
"Rowan rooted around the room until he found a small scrap of cotton from his wife’s sewing materials, suitable for use as a makeshift handkerchief."

show rowan intro neutral at midright with dissolve

ro "Here, take this."

"He handed it to the distressed young lady, who used it to dry the tears falling from her striking gold eyes, as she sniffled."
...
"Awkwardly, she tried to return the handkerchief, but Rowan just smiled as he motioned for her to keep it."
...
"With that, she bowed her head slightly and offered her hand. Rowan took it briefly, recalling the many women he had met at all of the balls following the triumph of the crusade. High born this one, he thinks."
...
"With a cry, Mariel slumped down in the seat, covering her face with her hands. At that moment, Alexia reentered from the other room, having heard a woman's voice."
...
"Alexia went over to the side of the room where the other woman is sat, weeping, and placed her arm around her in a delicate manner as not to startle her."
...
"The simple act of kindness seemed to help Mariel regain her composure, as she sat up straight, removing her hands from her face."
...
"Alexia returned with a cup and hands it to her."
...
"The thought that something may have happened to her child was too much for Mariel to bear, and she began to sob uncontrollably again."
...
"Rowan left the pair to recover his equipment, kept in storage for the better part of the last seven years."
...
"With a wink, Rowan left the pair to search for the child."
...
"Rowan looked up into the canopy above him, perhaps she had climbed a tree in order to get her bearings from a higher vantage point, or even to avoid danger?"

"Returning to his feet, he surveyed the landscape around him."
...
"From somewhere within the thick brush, an unseen assailant loosed an arrow. Luckily for Rowan, it missed its mark, flying harmlessly past him and embedding itself in a nearby tree."
...
"Half a dozen orcs emerged from the trees around him, surrounding him. Rowan could see no way out except through them. The largest one, their leader he reasoned, stepped forward. Confident in the odds, no doubt."
...
wo "Is no girl. Never was. Is trap. Yous stupid humi, fall for trap like all other stupid humis."
...
"He had to get back there. He fingerd the grip of his sword and eyed the orcs before him. The only way out is through."

wo "I know what yous thinkin’, don’t be stupid humi, be smart humi for change. Just put weapon down, don’t make fuss."

ro "Can’t do that, I’m afraid."

wo "Shame, we haveta kill yous then. Boss won’t be pleased."
...
menu:
    ...
    "Try to reason with him.":
        ...
        wo "Only ones walking away from this be orcs. Orders is orders, humi."
        ro "So be it."
        jump wildorcfight
...
"In a flash, Rowan drew his sword from its sheath just as the first orc rushed towards him. Bringing his blade up to meet the incoming axe, the sound of steel clashing against steel rang throughout the otherwise tranquil woods."
...
"Bracing his foot against the slumped orc, Rowan pulled his blade clear just in time to meet the next enemy’s blade. He still had his work cut out for him if he was to get out of these woods alive."
...
"Alexia rose from her chair and walked to the window, hoping to catch a glance of her husband returning down the lane to their cottage. To her despair, she saw nothing but the sun sinking lower to meet the horizon."
...
"With that, Mariel waved her hand and a hot white light pulsed through the room, sending Alexia tumbling backwards onto the hard wood floor."
...
wo "Stupid humi, why you no give up? You can’t win, we too strong."
...
"Powerful, but slow and deliberate, the hero thought as he batted another blow away. At this rate, it would not be long before he tires himself."

wo "Haha, see, this why yous stupid, humi. Me’s not talkin’ about orcs, me’s talkin’ about orcs’ masters. Kill me, kill lotsa orcs, don’t matta."

ro "And just who are these so called masters?"

wo "Me’s not telling, yous find out soon enough. Orcs’a not s’posed ta spoil the surprise."
...
"The two clashed again and again, the orc attempting to use his superior strength to force the advantage when their weapons lock. His smaller opponent, not foolish enough to engage in a contest of strength, opted to pirouette, sending the orc tumbling past him."
"As he span, he brought his sword back around, scoring a hit. The long bloody slash down the monster’s back caused the beast to cry out in rage."
...
play sound "music/SFX/orc_attack.ogg"
"With a final cry of rage, the orc charged Rowan one last time, intent on killing his foe. Tired and wounded, dodging it was no challenge for Rowan, who side stepped and hacked at the orc champion’s midsection."
"The blade found its target and bit deep. The orc sank to the ground, finally defeated."
...
"Sometime after Rowan left, the orc rose from the floor. He had only been playing dead all along, and though wounded severely, he was able to stand under his own power."

show wild orc wounded at orcright with dissolve

wo "See? Knew humi was stupid, can’t kill me’s, me’s strongest of all orcs!"

"As if responding to the orc’s claim, the shadows in the glade begin to lengthen until they crossed at the center. From the dark ground, as if stepping out through the very shadows themselves, appeared a demon; blood red in colour, covered in black markings."
...
wo "Humi was strong, big hero. An’ your sista said—"
...
"With lightning quickness, the demon plunged his clawed hand deep into the orc’s chest, piercing his heart. The orc dropped to the floor, and this time it was certain he would not be rising again."
...
"A few hours later, Rowan arrived back at the village to find it engulfed in flames. He had seen the smoke from the distance and feared the worst, and now those fears had been confirmed by the inferno that raged before him."
"There was no hope that a blaze this size could be quelled, Arthdale was doomed."
"Forcing his way through the acrid, black smoke he searched for survivors, but could find no trace of any of the villagers. Praying to Solansia that this is because they all fled to safety, and not because they had been consumed by flame, he pushed on towards his home in search of his wife."
...
"His cries returned no reply, but whether it was because nobody was able to hear over the roaring of the flames, or simply that there was no one around, he could not tell."
"The air began to sting Rowan’s eyes, and the more he breathed in, the more he felt his lungs filling with smoke. He pushed on, letting out a hacking cough as he continued his search. At this rate, it wouldn’t be long until he collapsed, he realized."
"Just as he was about to turn back, he saw his wife in the village square, but she was not alone."

show cg8 with dissolve
pause 2

"She knelt on the stone ground, surrounded by the flickering flames engulfing the village, her head held up by a shapely blue-skinned female demon."
"Beside her stood a more menacing figure, also a demon, but this one male, and with crimson hued skin, crossed with black markings."
...
"The female demon waved her hand, nonchalantly, to gesture at the flames still roaring around them."
...
"Ignoring his remark, Jezera continued to address Rowan."
...
"With only the two opponents, perhaps, if he chose him moment just right, he could get to Alexia before they realized and spirited her away from here."
...
"As Jezera bent to lift Alexia from the ground, her attention elsewhere, Rowan saw his moment appear."

show rowan attack at roleft with dissolve
"Seizing the opportunity he launched himself forward, pulling his sword clear from its scabbard and—"
...
"The red flash of demonic magic sparked through the air, as the full force of a spell evoked by Andras knocked him from his feet."
"Pain arced throughout his body as the magic drove him onto his knees."
"Despite his best efforts, Rowan could not rise. He couldn't even move, and now found himself, like his wife, at the mercy of the demonic siblings."
...
"Rowan could only look on in despair as the demons disappeared into the thick smoke, Andras carrying his wife."
"Though no longer held in place by Andras’ dark magic, it has sapped all the strength from his body, and he was unable to move as the flames raged around him."
...
"Rowan blinked a few times, heavily, freeing himself of the last vestiges of sleep. In the light of day he could see the full extent of the damage the fire had inflicted on the village, and it was not pretty."
...
"It all seemed so long ago now, he thought, as he crossed the span unchallenged. Even the tall iron gates that had barred them from entering the courtyard now waited for him, uncontested."

scene black with fade
"He retraced his steps as if he were almost reliving a memory. First, through the courtyard, and then into the castle proper. The vestibule was eerily quiet, he had at least expected a few guards, but there were none to be found anywhere."
"Pressing on, he made his way down the main corridor towards the throne room, where he and his friends had fought, and defeated, Karnas. The doors stood open, as if they were inviting him in."

scene bg6 with fade

"He stepped into the throne room to find it larger than he remembered. The long walk to the dais, flanked on either side by pillars of obsidian, and then, up those stairs, the throne."
...
"Jezera was clearly becoming visibly annoyed by Rowan’s unfriendly demeanor, and gave an audible sigh, more for show than from any genuine tiredness."
...
"Rowan began to open his mouth to speak, but Jezera, having had enough by the point, cut him off before he could even start."

je "You can see her shortly, and then that will be your proof that I am good for my word."

show jezera happy at edgeright with dissolve

"Rising from the throne to her feet, the annoyance melted off her face as she looked down at Rowan from the dais, replaced by a familiar, knowing smile."
...
"As she sat, weighing the implications of her conflicting desires, she heard a knock on her door."
...
"As he stepped into the doorway, she felt a pang of loneliness, accompanied by a tinge of guilt."
...
"The click of a mechanism, and before Rowan could so much as blink, the floor beneath him gave way. A trapdoor hidden beneath the castle’s regal carpet."
"As he fell, he reached out in vain to try and grab the edge, but could only watch it shrink smaller and smaller and he fell deeper into the darkness below."

play sound "music/SFX/BodyfallDirt.ogg"

"A few seconds later, Rowan discoverd the depth of the pit, colliding with the hard dirt at the bottom. He heard the sickening crack of bone, as searing agony shot up his leg."
"Broken leg, he thinks, and with the bone probably protruding from his shin to boot. He gritted his teeth and tried to suppress the sensation, but the pain is too much to bear, and it is not long until he passed out."
pause 2

play music "music/Dungeon Ambience.ogg" fadein 1.0
"How long he led unconscious in the pit he had no idea, but when he does wake sometime later, he felt cool stone pressed against his cheek, and dry straw scratching the bare skin of his side."
"Metal dug into his wrists, his hands had been shackled together, while the pain in his leg was completely gone. Whoever had bound him must have used magic to mend it while he was unconscious."
"Rolling over onto his back, he tried to open his eyes, only to be blinded by light coming in from above."
...
"As his eyes became accustomed to the light in the room, Rowan was able to see where he was; a cell in the castle dungeons."
"As he strained against the manacles, trying to force them apart and free his hands, a man’s voice rang out from the other side of the wall."
...
"Rowan stood and inspected his surroundings. The wooden door was no doubt locked, and looked as sturdy as the stone walls of the cell."
"Light was coming in from somewhere high above, but the walls were smooth and would offer no purchase, should he try to climb. At least, he thought, the cell is not too cramped."
...
if (door_escape == 1) & (climb_escape == 1) & (guard_escape == 1):
    ...
    menu:
        "Try the door.":
            $ renpy.fix_rollback()
            if (door_escape == 1):
                "Still locked, Rowan would have to find another way out."
                jump escape_options
            else:
                "Rowan tried the door, and his hopes that it might have accidently been left open soon melted away. He gave it a push, but it sat solidly in the frame, and did not budge."
                cm "I wouldn't get any ideas, if I were you."
                "Unwilling to be defeated by the wooden obstacle that stands in his way, Rowan took a couple of steps back, braced himself, and charged the door shoulder first."
                show bg8 with sshake
                "Unfortunately, the door has been reinforced with something stronger than just wood, and a magic barrier sent Rowan flying back across the room."
                "He slamed against the wall and slumped down to the stone floor, his shoulder lancing with pain. He would not be trying that particular method of egress again."
        ...
        "Try to climb up.":
            ...
            if (climb_escape == 1):
                ...
                "If light was coming from somewhere above, Rowan thought, that must mean there was a way out. While the walls were too slippery to climb, he could see one chain above him, low enough to grab."
                "Rowan reached up and tried to hoist himself from the ground using the chain as leverage, but it is old and rusted by years of exposure to the moist dungeon atmosphere, and the links split from the strain."
                show bg8 with sshake
                "Rowan fell down, arse first, against the cell floor. Climbing out was a non-option, and he had nothing to show for his escape attempt other than embarassment and a numb behind."
                $ climb_escape = 1
                jump escape_options
        ...
        "Call out to the guard.":
            ...
            if (guard_escape == 1):
                ...
                "Perhaps, Rowan thought, someone will come if he pretended to be injured. He called out at the top of his voice that he is bleeding, but his appeal for help brought no response."
    ...
    menu:
        ...
        "Try to climb up.":
            ...
            if (climb_escape == 1):
                ...
                "If light is coming from somewhere above, Rowan thought, that must mean there is a way out. While the walls were too slippery to climb, he could see one chain above him, low enough to grab."
                "Rowan reached up and tried to hoist himself from the ground using the chain as leverage, but it is old and rusted by years of exposure to the moist dungeon atmosphere, and the links split from the strain."
                show bg8 with sshake
                "Rowan fell down, arse first, against the cell floor. Climbing out was a non-option, and he had nothing to show for his escape attempt other than embarassment and a numb behind."
                $ climb_escape = 1
...
"All avenues of escape exhausted, Rowan slumped against the nearest wall, sitting back down on the straw near to where he awoke."
...
"It isn’t time for them to eat, Rowan thought, so probably another impromptu beating."

cm "No clinking of armour, or heavy footsteps. Something much lighter than an orc."

"Soft footsteps echoed down the dungeon hallway, until the visitor stoped outside the door to Rowan’s cell. The door swang open to reveal none other than Jezera."
...
"Jezera sighed, once again growing tired of having the same argument."
...
"Jezera opened the door and went back out into the hallway, leaving Rowan alone with his thoughts."

cm "I would listen to the woman if I were you, you don’t want to end up like me."

"The sinister cackle of his anonymous jail mate filled the room. Rowan felt an involuntary shudder go all the way through him, and hoped that would not be his fate."

hide rowan jail hurt with dissolve

"A few weeks later..."

"Rowan was woken up by the feel of a sharp jab in his ribs. He opened his eyes to see an orc towering above him, his metal boot pressed into his side."

show orc soldier neutral at orcright with dissolve

os "Get up humi, is time to go."

"Rowan rose to his feet, and attempted to shake of the vestigial remnants of sleep."
...
"The orc gave Rowan a solid shove in the direction of the door, and the human walked ahead of him out of the cell and into the corridor."

stop music
scene black with fade

"As he passed the next cell, he looked through the bars to find it empty. The other inhabitant of the dungeon seemingly vanished without a trace."
"The guard led him back upstairs to the first floor, and he was taken into a small chamber, where servants cleaned the dirt from his body, and shaved his face."
"Once they were finished, his escort resumed, and he found himself once again entering the throne room."
...
"When they reached the dais, the orc removed the manacles from his wrists, and left Rowan with the other two people present in the room, Andras and Jezera."
...
"The guard returned and took Rowan back to his cell."

play music "music/Dungeon Ambience.ogg" fadein 1.0
scene bg8 with fade

"Years pass. The guards continued to bring food, but neither Jezera nor anyone else ever visited him again. With escape beyond him, and no news of his wife or the outside world, Rowan's fate was sealed."
...
"Andras smirked, as a new idea formed in his mind."
...
menu:
    ...
    "Jezera.":
        ...
        $ rowanJezSex =+ 1
        "If I have to have sex with one of them, Rowan thought, I would prefer it to be the beautiful woman."
        ro "Jezera."
...
"The demon slid her dress down to reveal her shapely body, curvaceous, with a pert pair of large breasts."
...
"Rowan burned with shame as she spat on her hand and grabbed his cock at the root. With a gentle touch, she began to lightly jerk it up and down, with long soft strokes."
...
"With each stroke, she rose higher and took him deeper, the sensation becoming almost too much for him to bear."
...
"She held out a necklace to him with a single blue stone. Rowan took it from her."
...
"\"Another prison.\"  Rowan thought to himself as he placed the medallion over his head and was instructed in its use."
